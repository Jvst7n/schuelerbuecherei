...
public class DB {
  ...
  /**
   * Prüft, ob eine gültige Verbindung zur Datenbank besteht
  ...
  public static boolean isConnected()    {
    try {
      ...
      error = true;
      errormsg = "" + e.toString() + e.getMessage();
      return false;
    }   
  }
  ...
  public static void main(String args[]) throws SQLException {
    ...
    String sql1 = "SELECT * FROM buch WHERE registrierungsdatum='2011-02-15'";
    String sql2 = "SELECT * FROM person WHERE pin = 00000727";
    ArrayList<HashMap<String,String>> erg = DB.getSQLResults(sql1);
