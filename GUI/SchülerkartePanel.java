...
public class  SchülerkartePanel extends JPanel {
  // Anfang Attribute
  ...
  private JPanel Feld2 = new JPanel(null, true);
    private JPanel jPanel2 = new JPanel(null, true);
      ...
      private JComboBox<String> AuswahlBox = new JComboBox<String>();
      private DefaultComboBoxModel<String> AuswahlBoxModel = new DefaultComboBoxModel<String>();
