...
public class TestStartGUI extends JFrame {
  ...
  private BuchPanel jp_Buch  = new BuchPanel();
  ...
  //private ausgeliehenpanel jp_ausgeliehen = new ausgeliehenpanel();
  ...
  public TestStartGUI() { 
    ...
    jtf_Suchfeld.addActionListener(new ActionListener() { 
      public void actionPerformed(ActionEvent evt) { 
        ...
        jp_Buch.setBounds(40, 168, 1600, 842);
        jp_Buch.setLayout(null);
        jp_Buch.setBorder(BorderFactory.createBevelBorder(0, Color.DARK_GRAY, Color.GRAY));
        cp.add(jp_Buch);
      }
    });
    cp.add(jtf_Suchfeld);
    jb_Login.setBounds(1527, 16, 113, 41);
    ...
    /*jp_ausgeliehen.setBounds(40, 168, 1600, 842);
    jp_ausgeliehen.setLayout(null);
    //jp_ausgeliehen.setBorder(BorderFactory.createBevelBorder(0, Color.DARK_GRAY, Color.GRAY));
    cp.add(jp_ausgeliehen);
    */
